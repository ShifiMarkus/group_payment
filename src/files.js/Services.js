...
const service = {
    ...
    updateUser:async(id,newUser)=>{
        const users = await axios.put(`https://localhost:44320/api/users/${id}`,newUser)
        console.log(users);
    },
    ...
    addCash:async()=>{
        axios.post('https://localhost:44320/api/Cashes', {
            firstName: 'Fred',
            lastName: 'Flintstone'
          })
          .then(function (response) {
    ...
    updateCash:async(id,newCash)=>{
        const cashes = await axios.put(`https://localhost:44320/api/Cashes/${id}`,newCash)
        console.log(cashes);
    },
    ...
    addGroup:async()=>{
        axios.post('https://localhost:44320/api/Groups/', {
            firstName: 'Fred',
            lastName: 'Flintstone'
          })
          .then(function (response) {
    ...
    updateGroup:async(id,newGroup)=>{
        const groups = await axios.put(`https://localhost:44320/api/Groups/${id}`,newGroup)
        console.log(groups);
    },
    getPayments:async()=>{
    ...
    addPayment:async()=>{
        axios.post('https://localhost:44320/api/Payments/', {
            firstName: 'Fred',
            lastName: 'Flintstone'
          })
          .then(function (response) {
    ...
    deletePayment:async(id)=>{
       try{
        let res = await axios.delete(`https://localhost:44320/api/Payments/${id}`)
        if(res.status<200 || res.status>299){
    ...
    updatePayments:async(id,newPayment)=>{
        const payments = await axios.put(`https://localhost:44320/api/Payments/${id}`,newPayment)
        console.log(payments);
    },

    getuserInGroup:async()=>{
        const userInGroup = await axios.get(`https://localhost:44320/api/UsersInGroups`)
        console.log(userInGroup);
        return userInGroup.data;
    },
    getuserInGroupById:async(id)=>{
        const userInGroup = await axios.get(`https://localhost:44320/api/UsersInGroups/${id}`)
        console.log(userInGroup);
        return userInGroup.data;
    },
    adduserInGroup:async()=>{
        axios.post('https://localhost:44320/api/UsersInGroups/', {
            firstName: 'Fred',
            lastName: 'Flintstone'
          })
          .then(function (response) {
    ...
    deleteuserInGroup:async(id)=>{
       try{
        let res = await axios.delete(`https://localhost:44320/api/UsersInGroups/${id}`)
        if(res.status<200 || res.status>299){
    ...
    updateuserInGroup:async(id,newUsersInGroups)=>{
        const userInGroup = await axios.put(`https://localhost:44320/api/UsersInGroups/${id}`,newUsersInGroups)
        console.log(userInGroup);
    },
}
